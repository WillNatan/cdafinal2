 ...
 */
final class Version20180905073352 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE slider (id INT AUTO_INCREMENT NOT NULL, slide_image VARCHAR(255) NOT NULL, slide_url VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
